...
public class ErrorMessages {
  ...
  public static final String ERROR_ORDER_CANNOT_BE_CANCELED = "Order %s already canceled";

  public static final String ERROR_CART_DOES_NOT_CONTAIN_ITEM = "Shopping Cart %s does not contain item";
  public static final String ERROR_CART_ITEM_PRODUCT_INCOMPATIBLE = "Shopping CartItem %s does not contain product compatible";
