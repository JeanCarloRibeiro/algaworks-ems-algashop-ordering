...
class CustomersIT {
  ...
  void shouldPersistAndFind() {
    ...
    assertThat(savedCustomer).satisfies(s -> assertThat(s.id()).isEqualTo(customerId));
  }
  ...
  @Test
  public void shouldReturnValidateIfCustomerExists() {
    Customer customer = CustomerTestDataBuilder.brandNewCustomer().build();
  ...
  void shouldFindByEmail() {
    ...
    Optional<Customer> ofEmail = customers.ofEmail(customer.email());
